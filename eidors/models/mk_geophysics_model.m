...
SALT='z$Id: mk_geophysics_model.m 5903 2019-02-05 11:08:03Z aadler $'; % stick a key in the model 'save' file, so we can expire them when the model definitions age
